...
class PyMap:
    ...
    def __init__(self):
        ...
        port = self.Check_Predefined_Scan_Modes() or self.Arguments['port']
    ...
    def SetupArguments(self):
        ...
        predefined = self.Parser.add_argument_group(title="Predefined Port Lists", description="Use these options to scan a predefined list of ports.")
        ...
        predefined.add_argument("--web", dest="web", action="store_true", help="All ports commonly used for web services (80, 443, 8080, 8443).")
